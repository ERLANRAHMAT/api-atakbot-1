...
var creatorList = ['@ubah jadi nama lu','@alpha'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'ubah aja sesuai apikey yg lu mau') return res.json(loghandler.invalidKey)
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'ini jg') return res.json(loghandler.invalidKey)
